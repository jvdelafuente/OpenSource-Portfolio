...
export default function Footer() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (isOpen && !event.target.closest('.footer-container')) {
        setIsOpen(false);
      }
    };
  ...
  return (
    <div onClick={toggleFooter} className={`footer-container ${isOpen ? 'open' : ''}`}>
      <Contact />
    {isOpen && (
